            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8 animate-in zoom-in-95 duration-300">
                <div className="text-center mb-8">
                    <div className="w-14 h-14 bg-indigo-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                        {step === 1 ? <Key size={28} className="text-indigo-600" /> : <User size={28} className="text-indigo-600" />}
                    </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 bg-indigo-600 text-white text-xs font-medium rounded-lg hover:bg-indigo-700 transition-colors"
                            >
                ...
                <div className="mt-8 flex justify-end gap-3">
                    ...
                    <button
                        onClick={handleNext}
                        className="px-6 py-2.5 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200 flex items-center gap-2"
                    >
                        <Sparkles size={16} />
                ...
                <div className="flex justify-center gap-2 mt-6">
                    <div className={`w-8 h-1 rounded-full transition-colors ${step === 1 ? 'bg-indigo-600' : 'bg-gray-200'}`} />
                    <div className={`w-8 h-1 rounded-full transition-colors ${step === 2 ? 'bg-indigo-600' : 'bg-gray-200'}`} />
                </div>
            </div>
        </div>
    );
